...
int main(void)
{
    ...
    printf("*****insert after******\n");
    head = insert_after_value(&head, 100, 8);
    print_list(&head);
    head = insert_after_value(&head, 100, 18);
    print_list(&head);
	...
	printf("*****split from position******\n");
	head10 = split_from_position(&head10, 5);
	print_list(&head10);

	printf("*****split from value******\n");
	head10 = split_from_value(&head10, 3);
	print_list(&head10);
